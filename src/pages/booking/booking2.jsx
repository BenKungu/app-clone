...
import { appimg, devicemessage, doctor_01, google_store_1, googleimg, smartphone, todayicon } from '../../imagepath'
      ...
      <div className="col-md-12 col-12 text-center">
        ...
        <nav aria-label="breadcrumb" className="page-breadcrumb">
          <ol className="breadcrumb">
            ...
            <li className="breadcrumb-item" aria-current="page">Booking</li>
          </ol>
        </nav>
      </div>
    </div>
    ...
    <div className="row">
      <div className="col-lg-8 col-md-12">
        ...
        <div className="booking-btn">
          <Link to="#" className="btn btn-primary prime-btn justify-content-center align-items-center">
              ...
              <div className="booking-doctor-left">
                <div className="booking-doctor-img">
                  <Link to="/patient/doctor-profile">
                    <img src={doctor_01} alt />
                  </Link>
                </div>
                <div className="booking-doctor-info">
                  <h4><Link to="/patient/doctor-profile">Dr. John Doe</Link></h4>
                  <p>MBBS, Dentist</p>
                </div>
              </div>
            ...
            <div className="booking-doctor-details">
              <div className="booking-device">
                ...
                <div className="booking-doctor-info">
                  ...
                  <Link to="/patient/patient-chat" className="btn">Chat With Us</Link>
                </div>
              </div>
            </div>
          </div>
