...
import { home_01, home_02, home_03, home_04, home_05, home_06, home_07, home_08, home_09, home_10, home_11, logo_03, logo_15, logo_svg, logo_white } from "./imagepath";
  ...
  return (
    <>
      {(!pathnames.includes("home1")) &&
        <header
          className={`header ${pathnames.includes("/cosmeticshome") ? "header-fixed header-fourteen header-sixteen" : "" ||
            pathnames.includes("/index10") ? "header-fixed header-fourteen header-fifteen" : "" ||
              pathnames.includes("/home9") ? "header-fixed header-fourteen" : "" ||
                pathnames.includes("/paediatrichome") ? "header-fixed header-fourteen header-twelve header-thirteen" : "" ||
                  pathnames.includes("/home7") ? "header-fixed header-fourteen header-twelve" : "" ||
                    pathnames.includes("/home6") ? "header-trans header-eleven" : "" ||
                      pathnames.includes("/home4") ? "header-trans custom" : "" ||
                        pathnames.includes("/cardiohome") ? "header header-fixed header-ten" : "" ||
                          pathnames.includes("home") ? "header-trans header-two" : "header-fixed header-one"} `}
          style={pathnames.includes("/home6") && navbar ? { background: "rgb(30, 93, 146)" } : { background: "" } &&
            pathnames.includes("/index10") && navbar ? { background: "rgb(255, 255, 255)" } : { background: "" } &&
              pathnames.includes("/cosmeticshome") && navbar ? { background: "rgb(255, 255, 255)" } : { background: "" } &&
                pathnames.includes("/home4") && navbar ? { background: "rgb(43, 108, 203)" } : { background: "" } &&
                  pathnames.includes("/home9") && navbar ? { background: "rgb(43, 108, 203)" } : { background: "" } &&
                    pathnames.includes("/home") && navbar ? { background: "rgb(255, 255, 255)" } : { background: "" }}
          ...
          <div className="container">
            <nav className={`navbar navbar-expand-lg header-nav ${pathnames.includes("home1") ? "nav-transparent" : ""}`}  >
              <div className="navbar-header">
                <Link to="#0" id="mobile_btn" onClick={() => onhandleCloseMenu()}>
                ...
                <Link to="/home" className="navbar-brand logo">
                  {pathnames.includes("/cardiohome") ? (
                    ...
                    <img
                      src={
                        pathnames === "/home6" || pathnames === "/home4"
                          ? footer_logo
                          : pathnames === "/paediatrichome"
                            ? logosvg
                            : pathnames === "/cosmeticshome"
                              ? logo_15
                              : pathnames === "/index10" ?
                                logo_15 :
                                pathnames === "/home9" ?
              ...
              <div className="main-menu-wrapper">
                ...
                <ul className={`main-nav ${pathnames.includes("home4") ? "white-font" : ""}`}>
                  <li className={`has-submenu megamenu  ${pathnames.includes("home") ? "active" : ""}`} >
                    <Link to="#">
                        ...
                        <div className="megamenu-wrapper">
                          <div className="row">
                            ...
                            <div className="col-lg-2">
                              <div className="single-demo">
                                <div className="demo-img">
                                  <Link to="/home3" className="inner-demo-img">
                                    <img
                                      src={home_09}
                                      className="img-fluid"
                                      alt="img"
                            ...
                            <div className="col-lg-2">
                              <div className="single-demo">
                                <div className="demo-img">
                                  <Link to="/home4" className="inner-demo-img">
                                    <img
                                      src={home_08}
                                      className="img-fluid"
                                      alt="img"
                            ...
                            <div className="col-lg-2">
                              <div className="single-demo">
                                <div className="demo-img">
                                  <Link to="/cardiohome" className="inner-demo-img">
                                    <img
                                      src={home_07}
                                      className="img-fluid"
                                      alt="img"
                            ...
                            <div className="col-lg-2">
                              <div className="single-demo">
                                <div className="demo-img">
                                  <Link to="/home6" className="inner-demo-img">
                                    <img
                                      src={home_06}
                                      className="img-fluid"
                                      alt="img"
                            ...
                            <div className="col-lg-2">
                              <div className="single-demo">
                                <div className="demo-img">
                                  <Link to="/home7" className="inner-demo-img">
                                    <img
                                      src={home_05}
                                      className="img-fluid"
                                      alt="img"
                            ...
                            <div className="col-lg-2">
                              <div className="single-demo">
                                <div className="demo-img">
                                  <Link to="/paediatrichome" className="inner-demo-img">
                                    <img
                                      src={home_04}
                                      className="img-fluid"
                                      alt="img"
                            ...
                            <div className="col-lg-2">
                              <div className="single-demo">
                                <div className="demo-img">
                                  <Link to="/home9" className="inner-demo-img">
                                    <img
                                      src={home_03}
                                      className="img-fluid"
                                      alt="img"
                            ...
                            <div className="col-lg-2">
                              <div className="single-demo">
                                <div className="demo-img">
                                  <Link to="/index10" className="inner-demo-img">
                                    <img
                                      src={home_02}
                                      className="img-fluid"
                                      alt="img"
                            ...
                            <div className="col-lg-2">
                              <div className="single-demo">
                                <div className="demo-img">
                                  <Link to="/cosmeticshome" className="inner-demo-img">
                                    <img
                                      src={home_01}
                                      className="img-fluid"
                                      alt="img"
                  ...
                  <li className={`has-submenu ${url.includes("/doctor") ? "active" : ""}`}>
                    <Link to="#" className={isSideMenu == "doctors" ? "subdrop" : ""} onMouseEnter={() => toggleSidebar(isSideMenu == "doctors" ? "" : "doctors")} >Doctors <i className="fas fa-chevron-down" /></Link>
                    {isSideMenu == "doctors" ?
                  ...
                  <li className={`has-submenu ${url.includes("/patient") ? "active" : ""}`}>
                    <Link to="#" className={isSideMenu == "patients" ? "subdrop" : ""} onMouseEnter={() => toggleSidebar(isSideMenu == "patients" ? "" : "patients")} >Patients <i className="fas fa-chevron-down" /></Link>
                    {isSideMenu == "patients" ?
                      ...
                      <ul className={`submenu`}>
                        <li className={`has-submenu ${pathnames.includes("doctor") && !pathnames.includes("doctor-profile") && !pathnames.includes("search-doctor") ? "active" : ""}`}>
                          <Link to="#0" className={isSideMenutwo == "doctor" ? "subdrop" : ""} onMouseEnter={() => toggleSidebartwo(isSideMenutwo == "doctor" ? "" : "doctor")}>Doctors </Link>
                        ...
                        <li className={`has-submenu ${pathnames.includes("search-doctor") && !pathnames.includes("doctor-profile") && !pathnames.includes("search-doctor") ? "active" : ""}`}>
                          <Link to="#0" className={isSideSearch == "search-doctor" ? "subdrop" : ""} onMouseEnter={() => toggleSidebarsearch(isSideSearch == "search-doctor" ? "" : "search-doctor")}>Search Doctor </Link>
                          {isSideSearch == "search-doctor" ?
                            <ul className="submenu">
                              <li className={pathnames.includes("search-doctor1") ? "active" : ""}>
                                <Link to="/patient/search-doctor1" onClick={() => onhandleCloseMenu()}>Search Doctor 1</Link>
                              </li>
                              <li className={pathnames.includes("search-doctor2") ? "active" : ""}>
                                <Link to="/patient/search-doctor2" onClick={() => onhandleCloseMenu()}>Search Doctor 2</Link>
                              </li>
                            </ul> : ""
                          }
                        </li>
                        ...
                        <li className={`has-submenu ${pathnames.includes("booking") && !pathnames.includes("booking-success")  ? "active" : ""}`}>
                          <Link to="#0" className={isSidebooking == "booking" ? "subdrop" : ""} onMouseEnter={() => toggleSidebarbooking(isSidebooking == "booking" ? "" : "booking")}>Booking</Link>
                          {isSidebooking == "booking" ?
                            <ul className="submenu">
                              <li className={pathnames.includes("booking1") ? "active" : ""}>
                                <Link to="/patient/booking1" onClick={() => onhandleCloseMenu()}>Booking 1</Link>
                              </li>
                              <li className={pathnames.includes("booking2") ? "active" : ""}>
                                <Link to="/patient/booking2" onClick={() => onhandleCloseMenu()}>Booking 2</Link>
                              </li>
                            </ul> : ""
                          }
                        </li>
                  ...
                  <li className={`has-submenu ${url.includes("/Pharmacy") ? "active" : ""}`}>
                    <Link to="#"className={isSideMenu == "pharmacy" ? "subdrop" : ""} onMouseEnter={() => toggleSidebar(isSideMenu == "pharmacy" ? "" : "pharmacy")} >Pharmacy <i className="fas fa-chevron-down" /></Link>
                    {isSideMenu == "pharmacy" ?
                  ...
                  <li className={`has-submenu ${url.includes("/blog") ? "active" : ""}`}>
                    <Link to="#" className={isSideMenu == "blog" ? "subdrop" : ""} onMouseEnter={() => toggleSidebar(isSideMenu == "blog" ? "" : "blog")} >Blog <i className="fas fa-chevron-down" /></Link>
                    {isSideMenu == "blog" ?
                      <ul className="submenu">
                  ...
                  <li className="has-submenu">
                    <Link to="#" target="_blank" className={isSideMenu == "admin" ? "subdrop" : ""} onMouseEnter={() => toggleSidebar(isSideMenu == "admin" ? "" : "admin")} >Admin<i className="fas fa-chevron-down" /></Link>
                    {isSideMenu == "admin" ?
                  ...
                  {pathnames.includes("/cardiohome") || pathnames.includes("/cosmeticshome") ? (
                    <li className="searchbar">
                      <Link to="#">
                        <i> <FeatherIcon icon="search" /></i>
                      </Link>
                      <div className="togglesearch" style={{ display: "none" }}>
                        <form action={`${config.publicPath}patient/search-doctor1`} >
                  ...
                  {!pathnames.includes("/index10") && pathnames.includes("index") || pathnames.includes("/login") || pathnames.includes("/register") || pathnames.includes("blog") || pathnames.includes("/doctor/doctor-register") || pathnames.includes("pages") || pathnames.includes("/aboutus") && !pathnames.includes("/home6") ? (
                    <>
                      <li className="searchbar">
                        <Link to="#">
                          <i> <FeatherIcon icon="search" /></i>
              ...
              {pathnames.includes("/home6") ? (
                <ul className="nav header-navbar-rht">
                  <li className="nav-item">
                    <Link className={`nav-link header-login ${pathnames.includes("home6") ? "white-bg" : ""}`} to="/login">
              ...
              {pathnames.includes("home") && !pathnames.includes("/cosmeticshome") && !pathnames.includes("/cardiohome") && !pathnames.includes("/home6") && !pathnames.includes("/home7") && !pathnames.includes("/paediatrichome") && !pathnames.includes("/home9") ? (
                <ul className="nav header-navbar-rht">
                  <li className="nav-item">
                    <Link className={`nav-link header-login ${pathnames.includes("home4") ? "white-bg" : ""}`} to="/login">
                      login / Signup
                    </Link>
                  </li>
                </ul>
              ...
              {pathnames.includes("/cardiohome") || pathnames.includes("/home7") || pathnames.includes("/home9") ? (
                <ul className="nav header-navbar-rht">
                  {pathnames.includes("/cosmeticshome") || pathnames.includes("home7") || pathnames.includes("home9") ? (
                    <li className="searchbar searchbar-fourteen me-2">
                      <Link to="#"><i><FeatherIcon icon="search" /></i></Link>
                  ...
                  <li className={`${pathnames.includes("/home7") || ("/home9") ? "login-in-fourteen" : "register-btn"}`}>
                  <Link to="/pages/login-email" className={pathnames === "/home9" ? "btn reg-btn" : "btn log-btn" && pathnames === "/home7" ? "btn reg-btn" : "btn log-btn"}>
                      <i className="me-2">
                  ...
                  <li className={`${pathnames.includes("/home7") || ("/home9") ? "login-in-fourteen" : "register-btn"}`}>
                    <Link to="/signup" className={`${pathnames.includes("/home7") || ("/home9") ? "btn btn-primary reg-btn reg-btn-fourteen" : "btn reg-btn"}`}>
                      <i className="me-2"><FeatherIcon icon="user" /></i>
                      Sign Up
                    </Link>
                  </li>
              ...
              {pathnames.includes("patient") || pathnames.includes("Pharmacy") && !pathnames.includes("/Pharmacy/Pharmacy-index")? (
                <>
                  <ul className="nav header-navbar-rht">
                    <Chart />
                    <Notification />
                    <li className="nav-item dropdown has-arrow logged-item">
                      <Link to="#" className="dropdown-toggle nav-link" data-bs-toggle="dropdown">
                        <span className="user-img">
                          <img className="rounded-circle" src={IMG07} width="31" alt="Darren Elder" />
                        </span>
                      </Link>
                      <div className="dropdown-menu dropdown-menu-end">
                        <div className="user-header">
                          <div className="avatar avatar-sm">
                            <img src={IMG07} alt="User Image" className="avatar-img rounded-circle" />
                          </div>
              ...
              ) : (pathnames.includes("doctor") && !pathnames.includes("/doctor/doctor-register") && !pathnames.includes("/pages/doctor-signup")? (
                <ul className="nav header-navbar-rht">
                  <Chart />
                  <Notification />
                  <li className="nav-item dropdown has-arrow logged-item">
                    ...
                    <div className="dropdown-menu dropdown-menu-end">
                      <div className="user-header">
                        <div className="avatar avatar-sm">
                          <img src={IMG01} alt="User Image" className="avatar-img rounded-circle" />
                        </div>
                        <div className="user-text">
                          <h6>Darren Elde</h6>
              ...
              {pathnames.includes("/paediatrichome") ? (
                <ul className="nav header-navbar-rht">
                  ...
                  <li className="login-in-fourteen">
                    <Link to="/pages/login-email" className="btn reg-btn">Log In</Link>
                  </li>
                  <li className="login-in-fourteen">
                    <Link to="/signup" className=" reg-btn-thirteen"><span>Sign Up</span>
                ...
                <ul className="nav header-navbar-rht">
                  <li className="login-link"><Link to="/login">Login / Signup</Link></li>
                  <li className="login-in-fourteen">
                    <Link to="/pages/login-email" className="btn reg-btn"><i className="me-2"><FeatherIcon icon="video" /></i>Live Demo</Link>
                  </li>
                  <li className="login-in-fourteen">
                    <Link to="/signup" className="btn btn-primary reg-btn reg-btn-fourteen"><i
                      className="me-2"><FeatherIcon icon="shopping-cart" /></i>Buy Template</Link>
                  </li>
                </ul>
              ) : (
                null
              ...
              {pathnames.includes("/cosmeticshome") ? (
                <ul className="nav header-navbar-rht">
                  ...
                  <li className="login-in-sixteen">
                    <Link to="/pages/login-email" className="btn reg-btn"><i className="me-2"><FeatherIcon icon="lock" /></i>Login<span></span><span></span><span></span><span></span></Link>
                  </li>
                  <li className="login-in-sixteen">
                    <Link to="/signup" className="btn btn-primary reg-btn reg-btn-sixteen"><i className="me-2"><FeatherIcon icon="user" /></i>Sign Up</Link>
                  </li>
                </ul>
              ) : (
                null
